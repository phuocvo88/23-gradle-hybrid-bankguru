...
public class Level_20_Data_Test_IV_Data_Driven extends BaseTest{
	...
	public void Employee_01_Add_New_Employee() {
		...
		addEmployeePage.enterToTextboxByID_HRM(driver, "firstName", employeeData.getFirstname());

		log.info("Add_New_01 - Step 04:  Enter valid info to 'Last Name' textbox");
		addEmployeePage.enterToTextboxByID_HRM(driver, "lastName", employeeData.getLastname());
		...
		addEmployeePage.enterToTextboxByID_HRM(driver, "user_name", employeeData.getUsername());

		log.info("Add_New_01 - Step 08: Enter valid info to 'Password' textbox");
		addEmployeePage.enterToTextboxByID_HRM(driver, "user_password", employeeData.getPassword());

		log.info("Add_New_01 - Step 09: Enter valid info to 'Confirm Password' textbox");
		addEmployeePage.enterToTextboxByID_HRM(driver, "re_password", employeeData.getPassword());
		...
		employeeListPage.enterToTextboxByID_HRM(driver, "empsearch_employee_name_empName", employeeData.getFullname());
		verifyTrue(employeeListPage.isJQueryAjaxLoadedSuccess(driver));
